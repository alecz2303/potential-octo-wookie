...
<body>
	...
	<hr>
	<div style="width: 70%; border-radius: 10px 10px 10px 10px; -moz-border-radius: 10px 10px 10px 10px; -webkit-border-radius: 10px 10px 10px 10px; border: 0px solid #000000; -webkit-box-shadow: -14px 13px 7px  0px rgba(0,0,0,0.75); -moz-box-shadow: -14px 13px 7px 0px rgba(0,0,0,0.75); box-shadow: -14px 13px 7px 0px rgba(0,0,0,0.75); padding: 10px; border: 1px solid #000000;">
