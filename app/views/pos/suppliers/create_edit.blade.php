...
@section('content')
	...
	{{-- Create User Form --}}
	<form method="post" action="@if (isset($suppliers)){{ URL::to('pos/suppliers/' . $suppliers->people_id . '/edit') }}@endif" autocomplete="off" data-abide>
		<!-- CSRF Token -->
			...
			<div class="content active" id="panel1">
				<div class="row">
					...
					<div class="large-4 columns">
						...
						<small class="error">El nombre de la compañia es requerido y de tipo texto.</small>
					</div>
					<!-- ./ company_name -->
